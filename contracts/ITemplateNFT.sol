...
interface ITemplateNFT {
    ...
    function  safeMintOwnership(address to, uint256 creatorId, string memory uri) external;

    function mintTemplate(address _to, string memory _uri,  uint _proposalId) external;
